...
public class SupplementLog {
    ...
    @Convert(converter = EncryptionConverter.class)
    private TakingSupplement takingSupplement;  // 사용자 기준으로 복약 기록을 저장
    ...
    @Builder
    public SupplementLog(User user, TakingSupplement takingSupplement, String alarmName, String supplementName, LocalDateTime scheduledTime, Boolean visible) {
        this.user = user;
