...
@NoArgsConstructor
@AllArgsConstructor
public class TakingSupplementRequest {
    // 요일 상수 정의
    ...
    @JsonProperty("supplementSchedules")
    private List<SupplementSchedule> supplementSchedules; // 복용 스케줄 리스트
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class SupplementSchedule {
        // 시간대
        @JsonProperty("hour")
